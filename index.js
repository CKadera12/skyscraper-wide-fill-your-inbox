...
lib.ssMetadata = [
		{name:"index_atlas_", frames: [[162,0,152,204],[927,357,54,53],[976,282,22,57],[765,621,151,205],[622,0,151,205],[469,0,151,205],[162,206,151,205],[315,207,151,205],[468,207,151,205],[162,413,151,205],[621,414,151,205],[315,414,151,205],[612,621,151,205],[621,207,151,205],[459,621,151,205],[775,0,151,205],[774,414,151,205],[774,207,151,205],[468,414,151,205],[153,620,151,205],[306,621,151,205],[316,0,151,205],[0,602,151,205],[927,282,47,73],[928,0,86,280],[0,0,160,600]]}
];
...
(lib.bluetraytall_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.bluetraytall();
	this.instance.parent = this;
	this.instance.setTransform(-76,-102);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.bluetraytall_1, new cjs.Rectangle(-76,-102,152,204), null);
...
(lib.wideskyscraperinboxsomethingdelicious = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(50).call(this.frame_50).wait(113).call(this.frame_163).wait(4));

	// button
	this.btn_main = new lib.mainbutton();
	this.btn_main.parent = this;
	this.btn_main.setTransform(79.1,298.1);
	new cjs.ButtonHelper(this.btn_main, 0, 1, 2, false, new lib.mainbutton(), 3);

	this.timeline.addTween(cjs.Tween.get(this.btn_main).wait(167));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({alpha:0},9).wait(158));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(9).to({startPosition:0},0).to({scaleX:0.29,scaleY:0.29,y:42.1,alpha:1},6,cjs.Ease.get(1)).to({scaleX:0.27,scaleY:0.27,y:41.7},7,cjs.Ease.get(1)).wait(145));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(22).to({alpha:1},10).wait(135));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(66).to({alpha:1},10).wait(20).to({alpha:0},5).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(36).to({alpha:1},10).wait(20).to({alpha:0},5).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(96).to({alpha:1},10).wait(20).to({alpha:0},5).wait(36));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(126).to({alpha:1},10).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(50).to({y:283.7},0).to({y:328.4,alpha:1},10,cjs.Ease.get(1)).to({y:323.4},11,cjs.Ease.get(1)).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(this.rollover_color).wait(50).to({y:283.7,alpha:0},0).to({y:328.7,alpha:1},10,cjs.Ease.get(1)).to({y:323.7},11,cjs.Ease.get(1)).wait(96));
	...
	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:mask_2_graphics_0,x:80.6,y:333.6}).wait(50).to({graphics:mask_2_graphics_50,x:80.6,y:333.6}).wait(117));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(50).to({y:283.9},0).to({y:328.9,alpha:1},10,cjs.Ease.get(1)).to({y:323.9},11,cjs.Ease.get(1)).wait(96));

	// top-glasses-right
	this.instance_9 = new lib.glassestopright();
	this.instance_9.parent = this;
	this.instance_9.setTransform(136.5,46.5);
	this.instance_9.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(10).to({alpha:1},10).wait(147));

	// candle-2
	this.instance_10 = new lib.candle2mc();
	this.instance_10.parent = this;
	this.instance_10.setTransform(11,372.5);
	this.instance_10.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(21).to({alpha:1},10).wait(136));

	// candle-1
	this.instance_11 = new lib.candle1mc();
	this.instance_11.parent = this;
	this.instance_11.setTransform(54,381.5);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(29).to({y:382.5,alpha:1},10).wait(128));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(136).to({alpha:1},10).wait(21));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(126).to({alpha:1},10).wait(31));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(96).to({alpha:1},10).wait(61));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(82).to({alpha:1},0).wait(85));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(78).to({alpha:1},0).wait(89));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(74).to({alpha:1},0).wait(93));

	// cookie-fourteen
	this.instance_18 = new lib.cookiefourteen_1();
	this.instance_18.parent = this;
	this.instance_18.setTransform(84.5,500.8);
	this.instance_18.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(70).to({alpha:1},0).wait(97));

	// cookie-thirteen
	this.instance_19 = new lib.cookiethirteen_1();
	this.instance_19.parent = this;
	this.instance_19.setTransform(84.5,500.8);
	this.instance_19.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(66).to({alpha:1},0).wait(101));

	// cookie-twelve
	this.instance_20 = new lib.cookietwelve_1();
	this.instance_20.parent = this;
	this.instance_20.setTransform(84.5,500.8);
	this.instance_20.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(62).to({alpha:1},0).wait(105));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_21).wait(58).to({alpha:1},0).wait(109));

	// cookie-tene
	this.instance_22 = new lib.cookieten_1();
	this.instance_22.parent = this;
	this.instance_22.setTransform(84.5,500.8);
	this.instance_22.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_22).wait(54).to({alpha:1},0).wait(113));

	// cookie-nine
	this.instance_23 = new lib.cookienine_1();
	this.instance_23.parent = this;
	this.instance_23.setTransform(84.5,500.8);
	this.instance_23.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_23).wait(50).to({alpha:1},0).wait(117));

	// cookie-eight
	this.instance_24 = new lib.cookieeight_1();
	this.instance_24.parent = this;
	this.instance_24.setTransform(84.5,500.8);
	this.instance_24.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_24).wait(46).to({alpha:1},0).wait(121));

	// cookie-seven
	this.instance_25 = new lib.cookieseven_1();
	this.instance_25.parent = this;
	this.instance_25.setTransform(84.5,500.8);
	this.instance_25.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_25).wait(42).to({alpha:1},0).wait(125));

	// cookie-six
	this.instance_26 = new lib.cookiesix_1();
	this.instance_26.parent = this;
	this.instance_26.setTransform(84.5,500.8);
	this.instance_26.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_26).wait(38).to({alpha:1},0).wait(129));

	// cookie-five
	this.instance_27 = new lib.cookiefive_1();
	this.instance_27.parent = this;
	this.instance_27.setTransform(84.5,500.8);
	this.instance_27.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_27).wait(34).to({alpha:1},0).wait(133));

	// cookie-four
	this.instance_28 = new lib.cookiefour_1();
	this.instance_28.parent = this;
	this.instance_28.setTransform(84.5,500.8);
	this.instance_28.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_28).wait(30).to({alpha:1},0).wait(137));

	// cookie-three
	this.instance_29 = new lib.cookiethree_1();
	this.instance_29.parent = this;
	this.instance_29.setTransform(84.5,500.8);
	this.instance_29.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(26).to({alpha:1},0).wait(141));

	// cookie-two
	this.instance_30 = new lib.cookietwo_1();
	this.instance_30.parent = this;
	this.instance_30.setTransform(84.5,500.8);
	this.instance_30.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_30).wait(22).to({alpha:1},0).wait(145));

	// cookie-one
	this.instance_31 = new lib.cookietrayone();
	this.instance_31.parent = this;
	this.instance_31.setTransform(84.5,500.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(167));

	// table-cloth
	this.instance_32 = new lib.tableclothtall_1();
	this.instance_32.parent = this;
	this.instance_32.setTransform(43,218);
	this.instance_32.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_32).wait(19).to({alpha:1},10).wait(138));

	// blue-platter
	this.instance_33 = new lib.bluetraytall_1();
	this.instance_33.parent = this;
	this.instance_33.setTransform(84,501);
	this.instance_33.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_33).wait(64).to({alpha:1},10).wait(93));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_34).wait(167));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(56.1,270,206.1,656.2);
// library properties:
lib.properties = {
